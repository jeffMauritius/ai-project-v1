...
const footerLinks = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/monmariage.ai/',
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/people/Monmariageai/61576613646962/',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@Monmariageai',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            ...
            <div>
              ...
              <ul role="list" className="mt-6 space-y-4">
                {footerLinks.social.map((item) => (
                  <li key={item.name}>
                    <a href={item.href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm leading-6 text-gray-600 hover:text-pink-600 dark:text-gray-400 dark:hover:text-pink-400 transition-colors">
