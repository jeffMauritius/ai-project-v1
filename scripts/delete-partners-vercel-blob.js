...
async function deletePartnersVercelBlob() {
  console.log('🗑️ Suppression des images des partenaires Vercel Blob...')
  ...
  try {
    // Supprimer uniquement le dossier partners avec pagination
    ...
    console.log('\n🎉 Nettoyage des images des partenaires terminé!')
