...
async function modernizeDescriptionsWithShort() {
  console.log('🎨 Modernisation des descriptions avec version courte...')
  console.log('======================================================')
  ...
  try {
    ...
    for (const partner of partners) {
      ...
      console.log('  📋 Description courte (pour cartes):')
      console.log(`     Longueur: ${shortDescription.length} caractères`)
      console.log(`     Texte: ${shortDescription}`)

      if (originalDescription !== modernDescription) {
        console.log('  🔧 Descriptions mises à jour en base')
        
        // Mettre à jour en base de données avec les deux versions
...
if (require.main === module) {
  modernizeDescriptionsWithShort()
    .then(() => process.exit(0))
