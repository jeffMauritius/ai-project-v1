...
async function ultraFinalCleanup() {
  console.log('🧹 Nettoyage ultra-final des derniers suspects...')
  ...
  // Mots-clés ultra-spécifiques pour identifier les lieux/services
  const venueKeywords = [
    // Types de lieux très spécifiques
    'hôtel', 'auberge', 'résidence', 'villa', 'mas', 'bastide',
    'château', 'domaine', 'manoir', 'abbaye', 'moulin', 'ferme', 
    'salle', 'terrasses', 'clos', 'parc', 'jardin', 'bois', 'forêt', 
    'logis', 'prieuré', 'demeure', 'maison', 'chalet', 'lodge', 
    'centre', 'espace', 'lieu', 'site', 'endroit', 'paradis',
    'ermitage', 'gîte', 'camping',
    ...
    'privatisation', 'ouvre ses portes', 'célébrer', 'fêter',
  ...
  const suspiciousPhotographers = photographers.filter(photographer => {
    ...
    const photographerKeywords = [
      ...
      'marie', 'manon', 'tiphaine', 'sam', 'justine', 'lucie', 'caroline',
      'anne', 'sophie', 'claire', 'emilie', 'julie', 'sarah', 'laura'
    ]
