...
class SmartResumableGeocoder {
  ...
  async geocodeAllPartners() {
    console.log('🤝 Début de la géolocalisation des partenaires (détection intelligente)...')
  ...
  private async detectExistingProgress() {
    ...
    // Trouver le dernier ID traité pour reprendre
...
if (require.main === module) {
  const geocoder = new SmartResumableGeocoder(5, 1000) // 5 par batch, 1 seconde entre les requêtes
